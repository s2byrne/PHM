...
def create_model_info_dict():
    ...
    pfm_dir = '/expanse/lustre/projects/sds154/sbyrne/ROMS_all/PHM_Simulations/' # this stays fixed for Grids and executables
                                         # both forecasting and hindcasting use the same ones.
    if run_type == 'forecast':
       pfm_root_dir = '/scratch/PFM_Simulations/'       
    else:
       pfm_root_dir = '/expanse/lustre/projects/sds154/sbyrne/ROMS_all/PHM_Simulations/'       
...
# grid file locations
    ...
    PFM['ecmwf_dir'] = '/expanse/lustre/projects/sds154/sbyrne/ROMS_all/PHM_Simulations/ecmwf_data/'
